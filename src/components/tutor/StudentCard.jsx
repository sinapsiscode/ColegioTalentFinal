...
const StudentCard = ({ estudiante, onViewDetails, onEditObservations }) => {
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          <div className={`text-2xl font-bold mb-1 ${getPromedioColor(estudiante.promedio).split(' ')[0]}`}>
      ...
      <div className="flex items-center space-x-2">
        ...
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          onClick={() => onEditObservations(estudiante)}
