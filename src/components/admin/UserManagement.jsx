...
// Helper functions and constants moved outside component
const roleOptions = [
...
const UserStats = memo(({ users, filteredUsers, viewMode, onViewModeChange }) => (
...
// Memoized Bulk Actions component
...
const EmptyState = memo(({ searchTerm, roleFilter, statusFilter }) => (
...
// Memoized User Form Modal component
const UserFormModal = memo(({ isOpen, onClose, onSave, user, title, loading }) => {
...
const UserManagement = () => {
  ...
  const handleAssignChildren = useCallback((user) => {
    if (user.rol !== 'padre') {
  ...
  const handleBulkAction = useCallback(async (action) => {
    ...
    switch (action) {
      ...
      case 'delete':
        ...
        break
      case 'export':
        return // Export handled by button
    }
  ...
  }, [selectedUser, createUser, updateUser, loadUsers])
